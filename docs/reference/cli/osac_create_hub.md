...
```
  -h, --help                help for hub
      ...
      --kubeconfig string   Kubeconfig file containing the details to connect to the Kubernetes API.
      --namespace string    Namespace where cluster orders will be created.
```
