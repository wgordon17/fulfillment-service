## osac describe securitygroup

Describe a security group

### Synopsis

Display detailed information about a security group, identified by ID or name, including its ingress and egress rules.

```
osac describe securitygroup [flags] ID_OR_NAME
```
