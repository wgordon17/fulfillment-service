## osac describe virtualnetwork

Describe a virtual network

### Synopsis

Display detailed information about a virtual network, identified by ID or name.

```
osac describe virtualnetwork [flags] ID_OR_NAME
```

### Examples

```
  # Describe a virtual network by ID
